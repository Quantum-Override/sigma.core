...
void test_string_duplicate(void) {
    TEST_START("string_duplicate");

    string s1 = string_duplicate("hello");
    assert(s1 != NULL);
    assert(strcmp(s1, "hello") == 0);
    string_dispose(s1);

    // NULL input
    string s2 = string_duplicate(NULL);
    assert(s2 == NULL);

    // Empty string
    string s3 = string_duplicate("");
...
void test_string_copy(void) {
    ...
    string orig = string_duplicate("world");
    assert(orig != NULL);
...
void test_string_length(void) {
    ...
    string s = string_duplicate("test");
...
void test_string_concat(void) {
    ...
    string s1 = string_duplicate("hello");
    string s2 = string_duplicate(" world");
    ...
    // NULL inputs
    string s4 = string_duplicate("x");
    assert(string_concat(NULL, s4) == NULL);
    string_dispose(s4);

    string s3 = string_duplicate("y");
...
void test_string_compare(void) {
    ...
    string s1 = string_duplicate("abc");
    string s2 = string_duplicate("abc");
    string s3 = string_duplicate("def");
...
void test_string_to_array(void) {
    ...
    string s = string_duplicate("array");
...
void test_string_lifecycle(void) {
    ...
    string s1 = string_duplicate("lifecycle");
    assert(s1 != NULL);
...
void test_stringbuilder_from_string(void) {
    TEST_START("stringbuilder_from_string");
    
    string s = string_duplicate("initial");
    string_builder sb = stringbuilder_from_string(s);
    assert(sb != NULL);
    ...
    string_builder sb2 = stringbuilder_from_string(NULL);
    assert(sb2 != NULL);
...
void test_stringbuilder_to_string(void) {
    TEST_START("stringbuilder_to_string");
    
    string_builder sb = stringbuilder_new(0);
    stringbuilder_append(sb, "convert");
    
    string s1 = stringbuilder_to_string(sb);
    assert(s1 != NULL);
    assert(strcmp(s1, "convert") == 0);
    
    // Append more and convert again
    stringbuilder_append(sb, " more");
    string s2 = stringbuilder_to_string(sb);
...
void test_stringbuilder_lifecycle(void) {
    ...
    // Convert to string
    string final = stringbuilder_to_string(sb);
...
int main(void) {
    ...
    test_stringbuilder_from_string();
